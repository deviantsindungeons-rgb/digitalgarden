...
- On a 7+, choose two:
	- A 0 damage [[Items/Weapons\|weapon]] with a property of your choice.
	- A 1 damage weapon with a random property.
	- A set of [[Items/Armour\|armour]].
	- A shield and a helmet.
- On a 6-, choose one and gain an XP.
...
- On a 7-9, choose two.
- On a 6-, choose one. Gain an XP.

Determine any weird trinkets that you might have. Roll + [[System Mechanics/Attributes/Ichor\|Ichor]]. On a 7+, choose a [[Items/Magic Items\|magic item]]. On a 6-, you're flat out of luck. Gain an XP.